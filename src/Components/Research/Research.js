  ...
  return (
    <div className="Research" id="research">
      ...
      <div className="research-content-1">
        ...
        <div className="content">
          From Aug 2019 - present Number of members: 3 Summary: Created digital
          content for strengthening math, science training sessions for 9th and
          10th grade students including preparation of worksheets, powerpoint
          presentations, videos to explain concepts with experiments. Actively
          involved in setting up MCQ questions/answers and paper corrections
          activities. This effort took more than 2-3 hours every month starting
          from Aug 2019 Total Number of hours: 125+ Attach 3 docs
        </div>
        <div className="anchors">
          <a
            href="
            https://drive.google.com/file/d/1_6xJ0ZN7zahe4YTmyRvRsLOxKeAYP3hQ/view?usp=sharing
        "
            className="content-anchor"
          >
            Certificate
          ...
          <a
            href="
          https://c5e42103-989a-4674-9a72-290d2851be84.filesusr.com/ugd/fd16df_5a7197d6aa0c47ec8631f2735743ba01.pdf
      ...
      <div className="research-content-1">
        ...
        <div className="content">
          ...
          Participated in the Competition Presenting business case for my AI/ML
          engine
        </div>
        <a
          href="
          https://c5e42103-989a-4674-9a72-290d2851be84.filesusr.com/ugd/fd16df_b43f4c3128e64a45930ebeaef20f67a7.docx?dn=iitbombay.docx
